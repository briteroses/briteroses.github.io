...
First, the closed-form solution for the preference-tuning objective $$\eqref{eqn:objective}$$ is well-known in the KL-constrained RL literature, but we reproduce it here. First, rewrite the objective as:
